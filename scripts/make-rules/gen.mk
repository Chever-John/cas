...
gen.errcode.code: tools.verify.codegen
	@echo "===========> Generating cas error code go source files"
...
gen.ca.%:
	...
	@${ROOT_DIR}/scripts/gencerts.sh generate-cas-cert $(OUTPUT_DIR)/cert $(CA)
...
gen.defaultconfigs:
	@${ROOT_DIR}/scripts/generate_default_config.sh
